...
static const yytype_int16 yyrline[] =
{
     ...
     237,   240,   244,   252,   257,   263,   267,   273,   277,   283,
     287,   293,   297,   303,   307,   312,   316,   319,   323,   327,
     330,   341,   347,   358,   361,   366,   370
};
#endif
...
#line 244 "src/tpcas.y"
                 {
    (yyval.node) = makeNode(Expression);
    Node * tmp = makeNode(Or);
    addChild((yyval.node), tmp);
    addChild(tmp, (yyvsp[-2].node));
    addChild(tmp, (yyvsp[0].node));
    tmp->ident = strdup((yyvsp[-1].ident));
    }
...
#line 1583 "obj/tpcas.c"
    break;

  case 37: /* FB: M  */
#line 273 "src/tpcas.y"
         {
        (yyval.node) = (yyvsp[0].node);
        }
#line 1591 "obj/tpcas.c"
    break;
...
#line 1640 "obj/tpcas.c"
    break;

  case 43: /* T: F  */
#line 303 "src/tpcas.y"
         {
        (yyval.node) = (yyvsp[0].node);
        }
#line 1648 "obj/tpcas.c"
    break;

  case 44: /* F: ADDSUB F  */
#line 307 "src/tpcas.y"
                {
        (yyval.node) = makeNode(Addsub);
        addChild((yyval.node), (yyvsp[0].node));
        (yyval.node)->ident = strdup((yyvsp[-1].ident));
        }
#line 1658 "obj/tpcas.c"
    break;

  case 45: /* F: '!' F  */
#line 312 "src/tpcas.y"
             {
        (yyval.node) = makeNode(Not);
        addChild((yyval.node), (yyvsp[0].node));
        }
#line 1667 "obj/tpcas.c"
    break;
...
#line 1675 "obj/tpcas.c"
    break;

  case 47: /* F: NUM  */
#line 319 "src/tpcas.y"
           {
        (yyval.node) = makeNode(Num);
        (yyval.node)->num = (yyvsp[0].num);
        }
#line 1684 "obj/tpcas.c"
    break;

  case 48: /* F: CHARACTER  */
#line 323 "src/tpcas.y"
                 {
        (yyval.node) = makeNode(Character);
        (yyval.node)->ident = strdup((yyvsp[0].ident));
        }
#line 1693 "obj/tpcas.c"
    break;
...
#line 1701 "obj/tpcas.c"
    break;

  case 50: /* F: IDENT '(' Arguments ')'  */
#line 330 "src/tpcas.y"
                                {
        (yyval.node) = makeNode(Function);
        Node * tmp = makeNode(Ident);
...
#line 1715 "obj/tpcas.c"
    break;

  case 51: /* LValue: IDENT  */
#line 341 "src/tpcas.y"
             {
...
#line 1726 "obj/tpcas.c"
    break;

  case 52: /* LValue: IDENT '[' Exp ']'  */
#line 347 "src/tpcas.y"
                         {
        (yyval.node) = makeNode(Variable);
...
#line 1748 "obj/tpcas.c"
    break;

  case 54: /* Arguments: %empty  */
#line 361 "src/tpcas.y"
      {
        (yyval.node) = NULL;
        }
#line 1756 "obj/tpcas.c"
    break;

  case 55: /* ListExp: ListExp ',' Exp  */
#line 366 "src/tpcas.y"
                       {
        (yyval.node) = (yyvsp[-2].node);
        addSibling((yyval.node), (yyvsp[0].node));
        }
#line 1765 "obj/tpcas.c"
    break;

  case 56: /* ListExp: Exp  */
#line 370 "src/tpcas.y"
           {
        (yyval.node) = (yyvsp[0].node);
        }
#line 1773 "obj/tpcas.c"
    break;


#line 1777 "obj/tpcas.c"
